...
function crearGato(nombre, edad) {
   ...
   // Retornar el objeto.
   var objetoGato = {nombre:[] ,edad:[]};
    objetoGato.nombre = nombre;
    objetoGato.edad = edad;
    objetoGato.meow = function () {
        return "Meow!";
    }
    return objetoGato;
}
...
function nuevoUsuario(nombre, email, password) {
   ...
   // Retornar el objeto.
   var objetoUsuario = {nombre:[], email:[], password:[]};
...
function tieneEmail(objetoUsuario) {
   ...
   var tieneValor = objetoUsuario.email;
   if (tieneValor) {
      return true;
   } else {
      return false;
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   objetoProducto.calcularPrecioDescuento = function () {
     ...
     objetoProducto.precioFinal =this.precio - precioTotal;
